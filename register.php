...
<div class="row">
 ...
 $msg="";
	 ...
	 $mq=mysql_query("select max(id) from sc_company");
	 $mr=mysql_fetch_array($mq);
	 $id=$mr['max(id)']+1;
	
	 $ins=mysql_query("insert into sc_company(id,name,address,mobile,email,uname,pass,rdate) values($id,'$name','$address','$mobile','$email','$uname','$pass','$rdate')");
