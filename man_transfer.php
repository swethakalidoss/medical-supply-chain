...
<div class="alert alert-success">
  <strong>Transferred Success!</strong> 
</div>
<?php
}
...
<div class="row">
                ...
                <div class="card-block">
                  ...
                  <form name="name" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="location" placeholder="Transfer Location" class="form-control">
                    </div>
					<div class="form-group">
                      <label>Transfer Date</label>
                      <input type="date" name="tdate" placeholder="Transfer Date" class="form-control">
                    </div>
 ...
 $msg="";
	...
	$data="$tdate1,Transfer:$ttype-$transport,Location:$location";
	$hash=md5($data);
	...
	//////////////////////////////////////////////////////////////
	 ...
	 $ins=mysql_query("update sc_product set ttype='$ttype',transport='$transport',tlocation='$location',tdate='$tdate1',status=1 where id=$pid");
        
		 ?>
		 <script language="javascript">
		 window.location.href="man_transfer.php?act=success";
		 </script>
		 <?php
