...
extract($_REQUEST);
 ...
 $q11=mysql_query("select * from sc_company where uname='$uname'");
...
<div class="row">
                ...
                <div class="card-block">
                  ...
                  <form name="name" method="post" enctype="multipart/form-data">
                    <div class="form-group">
					  ...
					  <?php
					  $spq=mysql_query("select * from sc_supplier");
					...
					<div class="form-group">
                      ...
                      <input type="date" name="sdate" placeholder="Supply Date" class="form-control">
                    </div>
                     <div class="form-group">
 ...
 $msg="";
	...
	$data="$sdate1,Supplier:$supplier,Location:$location,Transport:$ttype-$transport";
	$hash=md5($data);
	...
	//////////////////////////////////////////////////////////////
	 ...
	 $ins=mysql_query("update sc_product set supplier='$supplier',slocation='$location',sdate='$sdate1',ttype='$ttype',transport='$transport',status=2 where id=$pid");
        
		 ?>
		 <script language="javascript">
		 window.location.href="man_sup.php?act=success";
		 </script>
		 <?php
