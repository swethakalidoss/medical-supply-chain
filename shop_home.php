...
<h3 align="center">Welcome Retailer (<?php echo $uname; ?>)</h3>
<div class="row">
			<div class="col-lg-3">
...
<!--end content area-->
  ...
  $qry=mysql_query("select * from sc_product where status=3 $q");
   ...
   <table width="90%" align="center">
				<thead>
				  <tr>
				    ...
				    <th class="card-primary">Supplied From</th>
				    <th class="card-primary">Sale</th>
				  </tr>
				</thead>
				<tbody>
				<?php
				...
				?>
				  <tr>
				    ...
				    <td><?php echo '<a href="shop_sale.php?pid='.$row['id'].'">Sale</a>'; ?></td>
				  </tr>
				  <?php
