...
<!--end content area-->
  ...
  $qry=mysql_query("select * from sc_product where status=0 $q");
   ...
   <table width="90%" align="center">
				<thead>
				  <tr>
					...
					<th class="card-primary">Category</th>
					
				    <th class="card-primary">Product</th>
				    <th class="card-primary">Rate</th>
				    <th class="card-primary">Manufacture on </th>
				    <th class="card-primary">Expiry</th>
				...
				?>
				  <tr>
				    ...
				    <td><a href="man_transfer.php?pid=<?php echo $row['id']; ?>">Transfer</a> | <a href="man_viewprd.php?act=del&did=<?php echo $row['id']; ?>">Delete</a> </td>
				  </tr>
				  <?php
