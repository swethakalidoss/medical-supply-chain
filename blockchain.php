...
$q11=mysql_query("select * from sc_product where id='$pid'");
...
if(isset($btn))
{
  ...
  <h3 align="center">Blockchain </h3>
   <table width="90%" align="center">
				<thead>
				  <tr>
					<th width="6%" class="card-primary">Block</th>
					<th width="94%" class="card-primary">Nonce</th>
					<th width="94%" class="card-primary">Previous Hash </th>
				    <th width="94%" class="card-primary">Hash</th>
				  </tr>
				</thead>
				<tbody>
				<?php
				...
				?>
				  <tr>
					...
					<td>&nbsp;</td>
					<td><?php  ?>
				    <input type="text" name="b1" value="<?php echo $row['hash_value']; ?>" /></td>
				    <td><input type="text" name="b2" value="<?php echo $row['hash_value']; ?>" /></td>
				  </tr>
				  <?php
