...
<div class="row">
 ...
 $msg="";
	 ...
	 $mq=mysql_query("select max(id) from sc_customer");
	 $mr=mysql_fetch_array($mq);
	 $id=$mr['max(id)']+1;
	
	 $ins=mysql_query("insert into sc_customer(id,name,address,mobile,email,uname,pass,rdate) values($id,'$name','$address','$mobile','$email','$uname','$pass','$rdate')");
                 
	 ?>
	 <script language="javascript">
	 window.location.href="reg_cus.php?act=success";
	 </script>
	 <?php
