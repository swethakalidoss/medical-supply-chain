...
<!--end content area-->
  ...
  $qry=mysql_query("select * from sc_product where status=1 $q");
   ...
   <table width="90%" align="center">
				<thead>
				  <tr>
				    ...
				    <th class="card-primary">Transfer by</th>
				    <th class="card-primary">Transport</th>
				    <th class="card-primary">Transfer Date</th>
				...
				?>
				  <tr>
				    ...
				    <td><?php echo $row['trasport']; ?></td>
				    <td><?php echo $row['tdate']; ?></td>
				    <td><a href="man_sup.php?pid=<?php echo $row['id']; ?>">Supply</a></td>
				  </tr>
				  <?php
